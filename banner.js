...
(function() {
    ...
    <div class="countdown-banner">
        <div class="countdown-banner-content">
            <div class="countdown-sponsor">Sponsor <a href="https://agentiloop.ai" target="_blank">Agent!</a> <span class="sponsor-sep">for</span> <a href="https://agentiloop.ai" target="_blank">macOS 26.4+</a> <span class="sponsor-dim">Agentic AI for your Apple Mac Desktop</span></div>
        </div>
        <div class="banner-nav">
            <a href="${homeLink}">Home</a>
            <a href="${docsLink}">Docs</a>
            <a href="${statsLink}">Stats</a>
            <a href="https://agentiloop.ai" target="_blank">Agent!</a>
        </div>
    </div>`;
